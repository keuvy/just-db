...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("DELETE /api/dumps/{name}", s.handleDumpDelete)
	s.mux.HandleFunc("GET /api/dumps", s.handleDumps)
	s.mux.HandleFunc("GET /api/profiles/{name}", s.handleProfileGet)
	s.mux.HandleFunc("PUT /api/profiles/{name}", s.handleProfilePut)
	s.mux.HandleFunc("DELETE /api/profiles/{name}", s.handleProfileDelete)
	s.mux.HandleFunc("GET /api/profiles", s.handleProfileList)
	s.mux.HandleFunc("POST /api/test-connection", s.handleTestConnection)
	s.mux.HandleFunc("POST /api/databases", s.handleListDatabases)
